...
clas :
  CLAS ID LBRACE stmtlist RBRACE { Clas{name=$1;body=$4;extend=[],pos=rhs 1} }
| CLAS ID EXTEND ID LBRACE stmtlist RBRACE { Clas{name=$1;body=$6;extend=[$4],pos=rhs 1} }
